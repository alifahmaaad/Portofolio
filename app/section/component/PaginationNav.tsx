const PaginationNav = () => {
  return (
    <div className="relative">
      <div className="fixed right-0 top-1/4 min-w-[2rem] bg-black bg-opacity-30 hover:bg-opacity-70 -translate-x-4 rounded-xl hover:opacity-100 duration-700 py-10 z-10">
        <div className="flex flex-col gap-5 justify-center items-center">
          <span className="px-2">
            <a
              className="items-center text-white hover:scale-110 flex"
              target="_blank"
